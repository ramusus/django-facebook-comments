...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.owner_id'
        db.alter_column(u'facebook_comments_comment', 'owner_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Comment.author_id'
        db.alter_column(u'facebook_comments_comment', 'author_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Comment.likes_count'
        db.alter_column(u'facebook_comments_comment', 'likes_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Comment.owner_id'
        db.alter_column(u'facebook_comments_comment', 'owner_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Comment.author_id'
        db.alter_column(u'facebook_comments_comment', 'author_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Comment.likes_count'
        db.alter_column(u'facebook_comments_comment', 'likes_count', self.gf('django.db.models.fields.IntegerField')())
